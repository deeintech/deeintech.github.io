...
- Edges and alphas decay over time. What works for you today may or may not work with more size, bigger players, or different market conditions, which reduces the likelihood of being able to run the same strategy for an indefinite period of time.
