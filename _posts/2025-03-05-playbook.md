...
This is a simplified version of bitcoin cycles. We have recently completed "Corretion Phase 1" (last update April 4th, 2025).
...
<iframe width="100%" height="420" src="https://www.youtube.com/embed/7Bn7wNMo8RY?si=xz8_cyy09F5de5q2" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
- BTC and strong memes perform well in liquidity tightening or QT. ETH and alts perform well in liquidity expansion or QE. Holding majority of your portfolio in ETH and alts during QT is a financial suicide. That's why 70-80% BTC is the golden rule you should not break. Yes, this is a more concervative allocation but it will protect you from holding assets that can't even outperform BTC.

- There's a 2-3 months delay between money injection and markets appreciation. It takes time for newly printed $$$ to find its way into the markets. All you need to do is follow a general direction of the M2 Money Supply chart and make all major decisions based on that. The rest is noise.
...
- **10% home runs**. Home runs are your big bets in crypto. Those require a clear thesis and a lot of patience. They are riskier and take a longer time to play out, but if you know what you're doing, that's your 20-100x opportunities.
...
#### Important ingredients for a decent home run:
...
#### Examples of angles/sectors for a good home run:
...
2. L1 Casinos. Every bull run there's always one or even multiple networks that host big onchain casinos. Holding an asset required to speculate in that casino is your home run here. Examples: ETH or Dash in 2017, MATIC or BNB in 2021, SOL or SUI in 2025, etc. You can read in more detail about the L1 Trade below.
...
#### A few interesting use cases for NFTs that you could explore:
...
#### A few mental and practical things you can do to deal with such insane volatility:
...
- Eric Dump Indicator. Created recently, potentially might evolve as a countertrade indicator to public buy signals by Eric.

![eric](/assets/images/eric.jpeg)
...
- Every important asset in crypto has a massive shakeout and manipulation phase before its big move. Big macro events and exchange hacks are the most vivid forms of desire to buy an asset lower. You know the asset is needed the most when it has the biggest manipulation. Hence, why I'm bullish on ETH in 2025.
