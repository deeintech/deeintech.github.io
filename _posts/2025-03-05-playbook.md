...
#### Three main components of a home run (a holy trifecta):
...
#### Important components for a decent home run:
...
- In most cases, BTC bottoms before equities bottom. BTC almost always leads the way.
