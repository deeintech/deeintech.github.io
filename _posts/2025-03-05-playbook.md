...
This is a simplified version of bitcoin cycles. We have just completed "Corretion Phase 1" (last update March 4th, 2025).

![banana](/assets/images/banana.jpeg)

Below are two videos that will explain a bigger macro picture and show where we are in the market. TLDR: follow the global liquidity.

<iframe width="100%" height="420" src="https://www.youtube.com/embed/W7ZL-nFoynw?si=4c-47X3VHpUpVArx" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

<iframe width="100%" height="420" src="https://www.youtube.com/embed/KxeZCCoOLB8?si=caR0fwamkT54XPu7" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

<iframe width="100%" height="420" src="https://www.youtube.com/embed/pO4xJ2jPbPo?si=Wci2v3go-2EazjEb" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
- Mascots of new chains. Many new chains have no tokens and the only way to bet on their growth is by investing in the corresponding face or mascot that represents a given chain. Examples: Toshi or Brett on Base, Abster on Abstract, Foxy on Linea.

- Classic memes with high cultural impact. Those are the memes that existed for over a decade and became a big part of the internet culture. They are more likely to become multi-cycle memes due to a large mindshare and cult-like community they've built over the years. Newly launched forced memes are unlikely to stick around. Hence, bet on the culture. Examples: Pepe, Bobo, Joe, etc.
...
- People who do TA never catch 100x — 1,000x in size. They get lost in the sauce and don't see the Big Picture. The key to wealth is to hold top coins within top themes for 1+ years.
...
- Beware of Binance manipulations. All coins typically move in unison and tend to dump 90% after listing. They all have a very similar chart pattern.
...
- Max greed forms bottoms, not tops. Ignore the noise and media.

![greed](/assets/images/greed.jpeg)
...
![loss](/assets/images/loss.jpeg)

- Peak speculation/extraction events (Justin Bieber buying BAYC for $1.3M, Trump launcing a coin) create tops against BTC pair for major L1 casinos. ETH topped when NFTs topped. SOL topped when SOL memes topped.
