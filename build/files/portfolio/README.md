...
## Projects
This is a list of my best work from companies I've worked with. It includes technical writing and front-end development samples. All of the files provided below are listed on my [GitHub](https://github.com/deeintech/deeintech.github.io/tree/master/assets/files/portfolio).
...
#### Tutorials
- [Myria Quickstart](/assets/files/portfolio/myria/tutorials/quickstart.pdf)
- [Create a collection](/assets/files/portfolio/myria/tutorials/create-collection.pdf)
- [Mint transactions overview](/assets/files/portfolio/myria/tutorials/mint-transactions.pdf)
...
#### SDK References
- [Projects Reference](/assets/files/portfolio/myria/sdk-references/projects.pdf)
- [Collections Reference](/assets/files/portfolio/myria/sdk-references/collections.pdf)
- [Minting Reference](/assets/files/portfolio/myria/sdk-references/minting.pdf)
...
#### Tutorials
- [A Complete Security Guide for Play-to-Earn Scholars](/assets/files/portfolio/seamless/tutorials/security-for-p2e.pdf)
- [The Ultimate MetaMask Guide for Play-to-Earn Scholars](/assets/files/portfolio/seamless/tutorials/metamask-for-p2e.pdf)
...
- [VRF Best Practices](/assets/files/portfolio/chainlink/tutorials/vrf-best.pdf)
- [Make an Existing Job Request](/assets/files/portfolio/chainlink/tutorials/job-requests.pdf)
- [Flight Aware Data Provider](/assets/files/portfolio/chainlink/tutorials/flight-aware.pdf)

#### Tutorials
- [API Calls Tutorial](/assets/files/portfolio/chainlink/tutorials/api-calls.pdf)
- [Register Keeper Upkeep for a Contract](/assets/files/portfolio/chainlink/tutorials/register-upkeep.pdf)
- [Arbitrum Feeds](/assets/files/portfolio/chainlink/tutorials/arbitrum-feeds.pdf)
- [L2 Sequencer Health Flag](/assets/files/portfolio/chainlink/tutorials/health-flag.pdf)
...
#### Code Samples
- [Retrieve Root Chain and Child Chain Balances](/assets/files/portfolio/omg_network/code_samples/retrieve-balances.pdf)
- [Deposit Funds](/assets/files/portfolio/omg_network/code_samples/deposit-funds.pdf)
- [Make a Transfer](/assets/files/portfolio/omg_network/code_samples/transfer.pdf)
- [Make an Atomic Swap](/assets/files/portfolio/omg_network/code_samples/atomic-swap.pdf)
- [Make a Fee Relay Transfer](/assets/files/portfolio/omg_network/code_samples/relay-transfer.pdf)
- [Manage UTXO](/assets/files/portfolio/omg_network/code_samples/manage-utxo.pdf)
- [Start a Standard Exit](/assets/files/portfolio/omg_network/code_samples/standard-exit.pdf)

#### Tutorials
- [Community Points Engine](/assets/files/portfolio/omg_network/tutorials/community-points.pdf)
- [Exchange Use Case](/assets/files/portfolio/omg_network/tutorials/exchange-use-case.pdf)
- [Wallet Use Case](/assets/files/portfolio/omg_network/tutorials/wallet-use-case.pdf)
- [Developer Portals Research](/assets/files/portfolio/blog/dev-portals-research.pdf)
- [How to Manage a VPS](/assets/files/portfolio/blog/manage-vps.pdf)
- [How to Run a Watcher](/assets/files/portfolio/omg_network/tutorials/run-watcher.pdf)

#### User Guides
- [Web Wallet Quick Start](/assets/files/portfolio/omg_network/tutorials/web-wallet.pdf)
- [MultiBaas by Curvegrid](/assets/files/portfolio/omg_network/tutorials/multibaas.pdf)
...
#### API Docs
- [Paytomat Console Panel API](/assets/files/portfolio/paytomat/api_docs/console-panel-api.pdf)

#### Whitepapers
- [Cryptobento Whitepaper](/assets/files/portfolio/paytomat/whitepapers/cryptobento.pdf)
- [Paytomat Whitepaper 2.0](/assets/files/portfolio/paytomat/whitepapers/paytomat-2.0.pdf)

#### User Guides
- [An instruction for Binance Dex trading in Paytomat Wallet](/assets/files/portfolio/paytomat/guides/binance-dex-trading.pdf)
- [Under the Hood of Paytomat Smart Contracts](/assets/files/portfolio/paytomat/guides/contracts-under-the-hood.pdf)
- [EOS Dapps Marketplace and How to use it](/assets/files/portfolio/paytomat/guides/eos-dapps-marketplace.pdf)
- [How to manage EOS resources in Paytomat Wallet](/assets/files/portfolio/paytomat/guides/eos-resources.pdf)
- [How to Monitor Revenue Smart Contract](/assets/files/portfolio/paytomat/guides/revenue-smart-contract.pdf)
- [Paytomat Wallet guide](/assets/files/portfolio/paytomat/guides/wallet-guide.pdf)

#### Announcements
- [Paytomat Announces a Support of Binance Chain](/assets/files/portfolio/paytomat/announcements/binance-chain.pdf)
- [Paytomat Wallet Features: Custom fees](/assets/files/portfolio/paytomat/announcements/custom-fees.pdf)
- [Paytomat Masternodes in Your Wallet](/assets/files/portfolio/paytomat/announcements/masternodes.pdf)
- [Paytomat is a Standby EOS Block Producer](/assets/files/portfolio/paytomat/announcements/producer.pdf)
- [Announcing Vote Paytomat Portal](/assets/files/portfolio/paytomat/announcements/vote.pdf)
- [Announcing A Refreshed Paytomat Wallet Design](/assets/files/portfolio/paytomat/announcements/wallet-2.0.pdf)
- [Paytomat Wallet Update: EOS dapps, Tezos support, and other improvements](/assets/files/portfolio/paytomat/announcements/zigzag.pdf)
- [Paytomat adds Zigzag dapp into Paytomat Wallet](/assets/files/portfolio/paytomat/announcements/wallet-update.pdf)
